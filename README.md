# TrackWatch · 行业追踪与市场情绪研究看板

轻量化专业投研风的单页静态看板：采集半导体设备 / CPO / 国产算力 / 存储芯片 / 恒生科技 / 美股市场六大赛道过去 24 小时的公开资讯，标准化标注事件属性后可视化呈现。品牌视觉：雷达徽章 Logo（`assets/logo.svg`、`assets/favicon.svg`），页面仅展示英文名 TrackWatch。
